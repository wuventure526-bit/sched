...
<html lang="en">
    ...
    <body>
        <p class="center-align mb-0">
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('assets/img/digistar-print-logo.png'))) }}" width="152" height="140" alt="">
        </p>
        <p class="center-align mb-0">
        ...
        <ul class="list-items">
            ...
            <li>
                <strong>Borrower Memo:</strong><br> {{ $jo_number }}
            </li>
            <li>
