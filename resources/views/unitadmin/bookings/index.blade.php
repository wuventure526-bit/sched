  ...
  <div class="card-header pb-0">
    <div class="d-flex align-items-center justify-content-between">
      <div>
        ...
        <p class="text-sm">{{ auth()->user()->seesAllUnits() ? 'View all bookings made by borrowers across every unit.' : 'View all bookings made by borrowers for your unit.' }}</p>
      </div>
      <div>
      ...
      <table class="table align-items-center mb-0">
        <thead>
          <tr>
            ...
            <th class="text-xxs font-weight-bolder px-2">JO#</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
  <p class="text-xs font-weight-bold mb-0">{{ $booking->jo_number ?? '-' }}</p> <!-- ADD THIS -->
</td>
            <td>
