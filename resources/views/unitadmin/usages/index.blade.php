        ...
        <thead>
            <tr>
                ...
                <th class="text-secondary text-xxs font-weight-bolder p-2">Item</th>
                 <th class="text-secondary text-xxs font-weight-bolder p-2">Purpose</th>
                ...
                <th class="text-secondary text-xxs font-weight-bolder p-2">Appoved By</th>
...
<td>
  <p class="text-xs font-weight-bold mb-0">
    {{ $usage->booking->jo_number ?? '-' }}
                ...
                <td class="align-middle">
                  <span class="text-xs font-weight-bold">{{optional($usage->user)->name ?? '—'}}
                <td>
                  <div class="d-flex align-items-center">
