            ...
            <div class="card-body">
                <div class="row">
                    <div class="d-flex flex-column h-100">
                        ...
                        <p class="mb-1 ps-3 text-sm">Start your day with a smile</p>
                        ...
                        <div class="card my-3 overflow-hidden"
                            ...
                            <div class="card-body overflow-hidden position-relative border-radius-xl p-3">
                                ...
                                <a href="{{ route('items.index') }}"
                                    class="ds-tile-link">See More <i class="fas fa-arrow-right ms-1"></i></a>
                            </div>
                        </div>
...
gradientStroke1.addColorStop(1, 'rgba(21,101,192,0.28)');
gradientStroke1.addColorStop(0.2, 'rgba(21,101,192,0.0)');
gradientStroke1.addColorStop(0, 'rgba(21,101,192,0)');

const gradientStroke2 = bookingChart.createLinearGradient(0, 230, 0, 50);
gradientStroke2.addColorStop(1, 'rgba(245,124,31,0.28)');
gradientStroke2.addColorStop(0.2, 'rgba(21,101,192,0.0)');
gradientStroke2.addColorStop(0, 'rgba(245,124,31,0)');

var gradientStroke3 = bookingChart.createLinearGradient(0, 230, 0, 50);
gradientStroke3.addColorStop(1, 'rgba(10,38,71,0.22)');
gradientStroke3.addColorStop(0.2, 'rgba(21,101,192,0.0)');
gradientStroke3.addColorStop(0, 'rgba(10,38,71,0)');
