document.addEventListener("DOMContentLoaded", function() {
    ...
    // Guard on the element, not on the year — the year is always truthy, so the
    // old check threw here on any page whose footer renders the year server-side
    // and took every listener below it down with it.
    if (yearElement) {
